...
const ResetPasswordPage = () => {
    ...
    // Token missing from URL — show error immediately
    if (!token) {
        return (
            <div className='min-h-[calc(100vh-64px)] flex justify-center items-center'>
                <div className='sm:w-[450px] w-[360px] shadow-custom py-10 sm:px-8 px-4 rounded-md text-center'>
                    ...
                    <Link to='/forgot-password' className='font-semibold underline text-slate-700 hover:text-black text-sm'>
            ...
            >
                ...
                <div className='flex flex-col gap-4'>
                    <div className='flex flex-col gap-1'>
                        <label className='text-sm font-semibold text-slate-700' htmlFor='rp-new'>
                ...
                <p className='text-center text-sm text-slate-700'>
                    <Link to='/forgot-password' className='font-semibold underline hover:text-black'>
                        Request a new link
                    </Link>
                </p>
            </form>
